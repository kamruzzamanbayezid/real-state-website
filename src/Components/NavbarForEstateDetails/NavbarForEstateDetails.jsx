...
const NavbarForEstateDetails = () => {
      ...
      return (
            <div className=" pt-4 relative z-50">
                  <div className="set-width navbar">
                        <div className="navbar-start">
                              ...
                              <Link to='/' className="text-white font-bold text-2xl md:text-3xl">LegacyEstates</Link>
                        </div>
...
export default NavbarForEstateDetails;