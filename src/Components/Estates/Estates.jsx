      ...
      return (
            <div className="my-10 lg:my-20 py-10 lg:py-20 bg-[#f3f4f9]">
                  <div className="max-w-[1170px] mx-auto p-4 lg:p-0">
                        ...
                        <h2 className="text-center text-[#0D1128] md:text-start font-sans font-medium border-l-8 border-[#BC986B] pl-3 border-b-2 w-fit pb-1 rounded text-5xl mb-20">Featured Properties!</h2>
